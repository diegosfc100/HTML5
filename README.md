...
<html> - Define um documento de HTML;

<head> - Contém informações para o documento;

<title> - Define o título do documento;

<body> - Define o corpo do documento;

<h1> to <h6> - Define os cabeçalhos;
...
<ruby> - Define uma anotação de ruby (para tipografia do Leste Asiático);
...
<template> - Define um contêiner para o conteúdo que deve ser oculto quando a página é carregada;

<time> - Define um horário específico (ou data e hora);

<u> - Define algum texto desarticulado e com estilo diferente do texto normal;
...
<canvas> - Usado para desenhar gráficos dinamicamente, via script (geralmente JavaScript);
...
---
```html
<audio> - Define o conteúdo do som;
...
<col> - Específica propriedades da coluna para cada coluna em um elemento <colgroup>;
